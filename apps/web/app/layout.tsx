...
export const metadata: Metadata = {
  ...
  description: "Launch your startup with our production-ready monorepo template. Pre-configured with Next.js 15, TypeScript, Tailwind CSS, and everything you need to focus on building your product.",
  keywords: ["MVP", "startup", "Next.js", "TypeScript", "Tailwind CSS", "monorepo", "template", "boilerplate"],
